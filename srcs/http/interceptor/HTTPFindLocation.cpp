...
{
	std::list<LocationBlock*>::iterator it = m_serverLocations.begin();
	std::list<LocationBlock*>::iterator ite = m_serverLocations.end();
	...
	while (it != ite)
	{
		...
		std::cout << "HTTPFindLocation::parse : " << std::endl;
